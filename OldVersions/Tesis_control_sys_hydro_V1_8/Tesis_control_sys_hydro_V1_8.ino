/*  Versión 1.8
    ...
    Comentarios: 
    - Adicion de funcion de control para servomotores
    - Adicion de lectura de sensor de pH SEN1601 de DFRobot
      con modulo de lectura ADC ADS1015 de Adafruit
    - Se elimino condicional de luces de crecimiento que evitaba su actualizacion
      una vez se hubieran encendido, lo cual estaba evitando que se encendieran.
    - Cantidad de pixeles funcionando: 75
*/
...
#define NUM_PIXELS 75                                                             // Cantidad de luces led en tira NeoPixel (122 en sistema completo)
...
const char* SSID = "Blue Dragon";                                               // SSID de red WiFi #1
//const char* SSID = "Tesis20168";                                                // SSID de red WiFi #2
const char* password = "12345671";                                              // Contrasena de red WiFi
//const char* SSID = "CLARO1_84DF73";                                             // SSID de red WiFi #3
//const char* password = "VSRU5ORKXQ";                                            // Contrasena de red WiFi
...
float growLightTime = 6;                                                          // Valor en horas
int time_of_day = 1;
...
void ambientAirParamsControl() // Checks ambient temperature and humidity values, changes state of fan_active flag if average values outside established limits
{
  ...
  ambient_T_max = 25.0; // ⚠️HARD CODED VALUE⚠️
  ambient_H_min = 30.0; // ⚠️HARD CODED VALUE⚠️
  ambient_H_max = 80.0; // ⚠️HARD CODED VALUE⚠️
