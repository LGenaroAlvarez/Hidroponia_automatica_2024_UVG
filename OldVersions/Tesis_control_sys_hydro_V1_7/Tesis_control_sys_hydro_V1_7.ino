/*  Versión 1.7
    ...
    Comentarios: 
    - Modificacion de funcion de control de ventiladores 
      (los ventiladores se mantienen encendidos 
      a menos que la bandera fan_activate sea 0)
    - Actualizacion de tiempo del RTC en caso de pérdida de potencia 
      utilizando datos del servidor HTTP al enviar datos
    - Modificacion a tiempos de lectura de sensores, ciclos de control y envio de datos.
      Ahora estos ocurren de manera consecutiva cuando esta activo 
...
#define SERVO_PH_PLUS 32                                                // Pin para control de servomotor para aumentar pH
