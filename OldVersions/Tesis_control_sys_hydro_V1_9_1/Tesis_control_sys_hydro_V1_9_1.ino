/*  Versión 1.9
    ...
    Comentarios: 
    - Se cambio funcion de conexion a WiFi (initWifi y wifiScan) por la funcion
      wifiMulti la cual conecta automaticamente a cualquier red disponible con
      la intensidad de conexion mas alta.
    - Se cambiaron condicionales para el ciclo de reconexion del sistema a WiFi
    - Replaced network_RSSI local variable for in JSON call of WiFi.RSSI() method
*/
...
#define CALI_BTN_1 35     // Pin para boton de seleccion de modo de calibracion del sensor de pH
